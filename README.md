...
- Below 60% the cards stop showing code and start showing a signature: body, badges and
  tools go, and the one line naming each function is scaled back up so it stays readable
